...
import 'package:tutorial/models/category_models.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void _getInitialInfo() {
    ...
    popularDiets = PopularDietsModel.getPopulaDiets();
  }
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${popularDiets[index].level} | ${popularDiets[index].level} | ${popularDiets[index].calorie}',
                              style: const TextStyle(
      ...
      actions: [
        GestureDetector(
          ...
          child: Container(
            ...
            child: SvgPicture.asset('assets/Icons/dots-3-horizontal.svg',
                width: 20, height: 20),
          ),
        ),
      ],
